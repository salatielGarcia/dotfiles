...
nnoremap <Leader>pdh <Esc>:!pandoc % --number-sections -s -c --bibliography=%:t:r.bib -o %:t:r.html -f markdown --filter pandoc-crossref -M figureTitle="Figure" -M tableTitle="Table" -M figPrefix="Fig." -M tblPrefix="Table"<CR>
