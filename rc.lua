...
--Volume widget
myVolText = wibox.widget.textbox( '  vol  ')
...
mytextclock = wibox.widget.textclock ("%a, %d %B %l:%M%p  ", 60)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "d",     function () awful.spawn("termite -t launcher -e /home/salatiel/scripts/lawnchair") end,
              {description = "run prompt", group = "launcher"}),
