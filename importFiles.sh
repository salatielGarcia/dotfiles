...
cp -u -v ~/.config/termite/config ~/dotfiles
cp -u -v ~/.config/kitty/kitty.conf ~/dotfiles
cp -u -v ~/.config/vifm/vifmrc ~/dotfiles
cp -u -v ~/.config/zathura/zathurarc ~/dotfiles
cp -u -v ~/.config/awesome/rc.lua ~/dotfiles
